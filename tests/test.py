...
parser = argparse.ArgumentParser(description='test sharedousocks')
...
client_args = python + ['sharedousocks/local.py', '-v']
server_args = python + ['sharedousocks/server.py', '-v']
