...
# sharedousocks UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# sharedousocks UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# sharedousocks UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of sharedousocks
# `remote`  means remote server of sharedousocks
...
from sharedousocks import encrypt, eventloop, lru_cache, common, shell
from sharedousocks.common import parse_header, pack_addr, onetimeauth_verify, \
...
class UDPRelay(object):
    ...
    def _handle_server(self):
        ...
        if self._is_local:
            ...
            # spec https://sharedousocks.org/en/spec/one-time-auth.html
