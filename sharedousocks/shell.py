...
from sharedousocks.common import to_bytes, to_str, IPNetwork
from sharedousocks import encrypt
...
def print_sharedousocks():
    version = ''
    try:
        import pkg_resources
        version = pkg_resources.get_distribution('sharedousocks').version
    except Exception:
        pass
    print('sharedousocks %s' % version)
...
def get_config(is_local):
    ...
    config['pid-file'] = config.get('pid-file', '/var/run/sharedousocks.pid')
    config['log-file'] = config.get('log-file', '/var/log/sharedousocks.log')
...
Online help: <https://github.com/sharedousocks/sharedousocks>
''')
